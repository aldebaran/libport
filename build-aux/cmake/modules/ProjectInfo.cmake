...
if(NOT PROJECT_INFO_CMAKE)
  ...
  function(project_describe_info major minor patch rc vendor vendor_ver n sha1)
    ...
    if(desc STREQUAL NOTFOUND)
      set(desc "0.0")
      echo("cannot find previous tag assume version is '${desc}'")
    endif(desc STREQUAL NOTFOUND)
	...
	if(PROJECT_VENDOR)
	  ...
	  if(vendor_tag MATCHES "^${vendor_ver_base_rx}")
	    ...
	    echo("cannot find previous tag for vendor '${PROJECT_VENDOR}' assume vendor version is ${vendor_ver}")
  ...
  if(PROJECT_VENDOR)
    set_if_not_set(PROJECT_COPYRIGHT_HOLDER ${GOSTAI_COPYRIGHT_HOLDER})
    set_if_not_set(PROJECT_COPYRIGHT_YEARS ${GOSTAI_COPYRIGHT_YEAR})
  else(PROJECT_VENDOR)
    set(PROJECT_COPYRIGHT_HOLDER ${GOSTAI_COPYRIGHT_HOLDER})
    set(PROJECT_COPYRIGHT_YEARS ${GOSTAI_COPYRIGHT_YEAR})
  endif(PROJECT_VENDOR)
  ...
  if(PROJECT_LONGNAME STREQUAL PROJECT_NAME)
    set(PROJECT_TAG_MSG "Release ${PROJECT_NAME}")
  else(PROJECT_LONGNAME STREQUAL PROJECT_NAME)
    set(PROJECT_TAG_MSG "Release ${PROJECT_LONGNAME} aka. ${PROJECT_NAME}")
  endif(PROJECT_LONGNAME STREQUAL PROJECT_NAME)
  if(PROJECT_VENDOR)
    set(PROJECT_TAG_MSG
